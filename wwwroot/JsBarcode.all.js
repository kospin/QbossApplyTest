...
// Default values
function MyBarcode(element,text){
    JsBarcode(element,text, {
			format: "code39", width: 1, height: 80, displayValue: true
		} 
    );
}
...
// 128A (Code Set A)
// ASCII characters 00 to 95 (0??, A?“Z and control codes), special characters, and FNC 1??
var A_CHARS = exports.A_CHARS = "[\x00-\x5F\xC8-\xCF]";

// 128B (Code Set B)
// ASCII characters 32 to 127 (0??, A?“Z, a?“z), special characters, and FNC 1??
var B_CHARS = exports.B_CHARS = "[\x20-\x7F\xC8-\xCF]";

// 128C (Code Set C)
// 00??9 (encodes two digits with a single code point) and FNC1
